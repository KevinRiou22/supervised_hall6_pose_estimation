...
config.H36M_DATA.BONES_NAMES = ['rhip', 'rknee', 'rfoot', 'lhip', 'lknee', 'lfoot', 'spine', 'thorax', 'neck', 'head', 'lshoulder', 'lelbow', 'lwrist', 'rshoulder', 'relbow', 'rwrist']
config.H36M_DATA.STRUCT_TRIANG_ORDER = ['rknee', 'rhip', 'lhip', 'lknee', 'lfoot','rfoot', 'spine', 'thorax', 'head', 'rwrist', 'relbow', 'rshoulder', 'lshoulder', 'lelbow', 'lwrist', 'neck']
...
config.HALL6_DATA.TRAIN_SAMPLE_CAMERAS = []
